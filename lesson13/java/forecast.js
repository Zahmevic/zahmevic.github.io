const apiURLb = "https://api.openweathermap.org/data/2.5/forecast?q=Cozumel,quintana_roo,mx&APPID=2eff4028c413e1406dc240f494003a91&units=imperial"

fetch(apiURLb)
.then((response) => response.json())
.then((jsObject) => {console.log(jsObject); //este es el nombre que le puse
const week = jsObject.list.filter(h => h.dt_txt.includes('12:00:00')); //selecciono los items que usaré
console.log(week);
